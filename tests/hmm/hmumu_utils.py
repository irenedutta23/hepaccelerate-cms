...
def analyze_data(
    ...
    for jet_syst_name, jet_pt_vec in jet_pt_syst.items():
        ...
        if is_mc and dataset_name == "dy_m105_160":
            mask_dijet_genmass = (ret_jet["dijet_inv_mass_gen"] < 350)
            dnn_presel = dnn_presel & mask_dijet_genmass
